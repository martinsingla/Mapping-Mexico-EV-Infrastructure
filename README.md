...
The libraries utilized for this project include Tidyverse and sf (for spatial data manipulation), leaflet (R application from JavaScript's interactive mapping tool) and Shiny (to create interactive dashboards). The final output has been hosted in:
